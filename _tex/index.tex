...
\begin{tcolorbox}[enhanced jigsaw, arc=.35mm, breakable, opacityback=0, colback=white, left=2mm, bottomrule=.15mm, bottomtitle=1mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, toptitle=1mm, colbacktitle=quarto-callout-note-color!10!white, titlerule=0mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, coltitle=black, toprule=.15mm, leftrule=.75mm, rightrule=.15mm]
